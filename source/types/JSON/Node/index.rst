...
.. list-table::
	...
	* - Name
	  - Description
	* - :doc:`/types/JSON/Node/getType/index`
	  - Returns the Node's :doc:`/types/JSON/Type/index`.
	* - :doc:`/types/JSON/Node/contains/index`
	  - Checks if the Object Node contains a certain key.
	* - :doc:`/types/JSON/Node/size/index`
