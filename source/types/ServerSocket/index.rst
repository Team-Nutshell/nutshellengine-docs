...
.. list-table::
	...
	* - Name
	  - Description
	* - :doc:`/types/ServerSocket/sendDataToClient/index`
	  - Sends data to a client.
	* - :doc:`/types/ServerSocket/setClientConnectCallback/index`
	  - Sets the function that will be called when a client connects to the server.
	* - :doc:`/types/ServerSocket/setClientDisconnectCallback/index`
