...
.. list-table::
	...
	* - Name
	  - Description
	* - :doc:`/types/JobSystemInterface/execute/index`
	  - Launches a job to be executed by a worker thread.
	* - :doc:`/types/JobSystemInterface/dispatch/index`
	  - Launches a job to be executed by multiple worker threads.
	* - :doc:`/types/JobSystemInterface/isBusy/index`
	  - Checks if any worker thread is still executing a job.
	* - :doc:`/types/JobSystemInterface/wait/index`
	  - Waits for all worker threads to finish their jobs.
	* - :doc:`/types/JobSystemInterface/getNumThreads/index`
